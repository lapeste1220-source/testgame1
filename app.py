...
#stage{position:relative;width:1360px;height:764px;transform-origin:center center;}
...
#board{position:absolute;left:418px;top:14px;width:736px;height:736px;
...
/* 가운데 승리조건 패널 */
#centerPanel{position:absolute;left:560px;top:300px;width:300px;
...
/* 점수판 */
#score{position:absolute;left:16px;top:14px;width:372px;background:rgba(255,255,255,.92);
...
/* 우측 조작부 */
#right{position:absolute;right:18px;top:14px;width:362px;text-align:center;}
...
#overlay{position:absolute;left:418px;top:14px;width:736px;height:736px;display:none;
...
/* ===================== 스케일(한 화면 고정) ===================== */
function fit(){ const s=Math.min(window.innerWidth/1360, window.innerHeight/764);
